...
@section('content')
    ...
    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
        <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
            <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Admin Authentication</h4>
        </div>
    </div>
    <div class="card-body">
        @if(session('success'))
        ...
        <form role="form" class="text-start" method="POST" action="{{ route('admin.verify2fa') }}">
        @csrf
        ...
        <form role="form" class="text-center" method="POST" action="{{ route('admin.resend2fa') }}">
        @csrf
