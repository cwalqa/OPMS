...
@section('content')
    ...
    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
        <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
            <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">ADMIN PORTAL</h4>
        </div>
    </div>
    <div class="card-body">
        ...
        @csrf
            ...
            <p class="mt-4 text-sm text-center">
                Forgot Password?
                <a href="https://datapluzz.com" class="text-primary text-gradient font-weight-bold">Contact ColorWrap Admin</a>
            </p>
        </form>
    </div>
