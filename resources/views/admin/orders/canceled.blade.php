            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 d-flex justify-content-between">
                        <h6 class="text-white text-capitalize ps-3">Canceled Purchase Orders</h6>
                        <!-- Search Input -->
                        <input type="text" id="caceledOrderSearchInput" placeholder="Search..." class="form-control w-25 me-3">
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.viewCanceledOrderDetails', $order->id) }}" class="btn btn-secondary btn-sm">
                                            View Details
                                        </a>
                                    </td>
                                </tr>
