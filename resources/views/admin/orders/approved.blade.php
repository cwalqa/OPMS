            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 d-flex justify-content-between">
                        <h6 class="text-white text-capitalize ps-3">Approved Purchase Orders</h6>
                        <!-- Search Input -->
                        <input type="text" id="approvedOrderSearchInput" placeholder="Search..." class="form-control w-25 me-3">
                    </div>
                </div>
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive p-3">
                        <table class="table align-items-center mb-0" id="approvedOrderTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-sm font-weight-bolder opacity-10 ps-2">Approved By</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.viewApprovedOrderDetails', $order->id) }}" class="btn btn-secondary btn-sm">
                                            View Details
                                        </a>
                                    </td>
                                </tr>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const searchInput = document.getElementById('approvedOrderSearchInput');
        const table = document.getElementById('approvedOrderTable');
