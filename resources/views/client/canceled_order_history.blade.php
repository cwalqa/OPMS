            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 d-flex justify-content-between">
                        ...
                        <!-- Search Input -->
                        <input type="text" id="canceledOrderSearchInput" placeholder="Search..." class="form-control w-25 me-3">
                    </div>
                </div>
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive p-3">
                        <table class="table align-items-center mb-0" id="canceledOrderTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-primary text-sm font-weight-bolder opacity-10 ps-2">Canceled On</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-xs font-weight-bold mb-0">{{ $order->updated_at->format('Y-m-d') }}</p>
                                    </td>
                                    <td>
                                        <a href="{{ route('client.viewCanceledOrderDetails', $order->id) }}" class="btn btn-secondary btn-sm">
                                            Order Details
                                        </a>
                                    </td>
                                </tr>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const searchInput = document.getElementById('canceledOrderSearchInput');
        const table = document.getElementById('canceledOrderTable');
