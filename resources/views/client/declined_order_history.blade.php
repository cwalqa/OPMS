            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 d-flex justify-content-between">
                        <h6 class="text-white text-capitalize ps-3">DECLINED ORDERS</h6>
                        <!-- Search Input -->
                        ...
                        <table class="table align-items-center mb-0" id="declinedOrderTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-primary text-sm font-weight-bolder opacity-10 ps-2">Declined On</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('client.viewDeclinedOrderDetails', $order->id) }}" class="btn btn-secondary btn-sm">
                                            Order Details
                                        </a>
                                    </td>
                                </tr>
