				...
				<div class="card my-4">
					<div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
						<div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
							<h6 class="text-white text-capitalize ps-3">CANCELED ORDER DETAILS</h6>
						</div>
					</div>
					<div class="card-body px-0 pb-2">
						<div class="table-responsive p-3">
							...
							<div class="row d-flex justify-content-center align-items-center mb-3 order-info-row">
                                ...
                                <div class="col-md-3">
									<div class="form-group">
										<label for="cancel_date"><b>Canceled Date/Time</b></label>
										<input type="text" name="cancel_date" id="cancel_date" class="form-control" value="{{ $order->updated_at->format('Y-m-d H:i:s') }}" readonly>
									</div>
								</div>
								<!-- <div class="col-md-3">
									<div class="form-group">
                            ...
                            <div class="row mt-2">
								<div class="col-md-12">
									<div class="form-group">
										<label for="cancel_reason"><b>Reason For Cancellation</b></label>
										<textarea id="cancel_reason" class="form-control" rows="2" readonly>{{ $order->cancel_reason }}</textarea>
									</div>
								</div>
							</div>
							<!-- Action Buttons -->
							<div class="row mt-4">
								<div class="col-md-6 text-start">
									<a href="{{ route('client.canceledOrderHistory') }}" class="btn btn-secondary">
										Back to Canceled Orders
									</a>
								</div>
