...
class SyncCustomerAndItems extends Command
{
    protected $signature = 'quickbooks:sync-customers-items';
        ...
        if (isset($customer_data) && !empty($customer_data)) {
            foreach ($customer_data as $customer_details) {
                ...
                $insert_customer_data[] = [
                    ...
                    'is_active' => $is_active,
                    'customer_ref' => $customer_details['CustomerRef'] ?? null, // Populate customer_ref
                ];
            }
        ...
        if (isset($item_data) && !empty($item_data)) {
            foreach ($item_data as $item_details) {
                ...
                $insert_item_data[] = [
                    ...
                    'is_active' => $is_active,
                    'sku' => $item_details['Id'], // Populate sku with item_id values
                ];
            }
